<template>
    <div class="lg:mr-4">
        <div class="flex justify-center items-center gap-8 sm:gap-20 flex-wrap mt-26 lg:p-0 p-4 mb-4 w-full lg:mr-4" style="z-index: 999;">
            ...
            <div 
                ...
                class="w-full bg-secondary/10 text-justify mt-10 p-4 rounded text-secondary">
                <div v-for="i in paragraph" :key="i">
